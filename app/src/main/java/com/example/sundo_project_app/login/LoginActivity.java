...
public class LoginActivity extends AppCompatActivity {
    ...
    private static final String LOGIN_URL = "http://172.30.1.44:8000/api/companies/login"; // 서버의 로그인 엔드포인트
    private static final String VALIDATE_TOKEN_URL = "http://172.30.1.44:8000/api/validate-token"; // 서버의 토큰 검증 엔드포인트
